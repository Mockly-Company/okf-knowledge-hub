  ...
  return (
    <main className="workspace-connection" aria-live="polite">
      <div className="workspace-connection__card">
        ...
        {state.step === "local" ? <LocalConnectionStep state={state} onConnectExisting={() => void connection.connectExistingClone()} onClone={() => void connection.cloneIntoSelectedParent()} onPreviewInitialization={() => void connection.previewInitialization()} onRecover={recover} /> : null}
